...
> [!NOTE]
> **Heads-up for Demoing**
> 
> The API is deployed on a free-tier service that spins down when inactive. Please allow **30-60 seconds** for the first request to "wake up" the server. After that, it will be fast!
